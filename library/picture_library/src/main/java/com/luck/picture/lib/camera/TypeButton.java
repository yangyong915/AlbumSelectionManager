...
public class TypeButton extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (button_type == TYPE_CANCEL) {
            ...
            mPaint.setColor(JCameraView.COLOR_TYPE_BUTTON_CANCEL_BACKGROUND);
            mPaint.setStyle(Paint.Style.FILL);
            canvas.drawCircle(center_X, center_Y, button_radius, mPaint);

            mPaint.setColor(JCameraView.COLOR_TYPE_BUTTON_CANCEL_OBJECT);
        ...
        if (button_type == TYPE_CONFIRM) {
            mPaint.setAntiAlias(true);
            mPaint.setColor(JCameraView.COLOR_TYPE_BUTTON_CONFIRM_BACKGROUND);
            mPaint.setStyle(Paint.Style.FILL);
            canvas.drawCircle(center_X, center_Y, button_radius, mPaint);
            mPaint.setAntiAlias(true);
            mPaint.setStyle(Paint.Style.STROKE);
            mPaint.setColor(JCameraView.COLOR_TYPE_BUTTON_CONFIRM_OBJECT);
            mPaint.setStrokeWidth(strokeWidth);
